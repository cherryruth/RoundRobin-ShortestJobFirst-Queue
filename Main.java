...
public class Main
{
	...
	public ArrayList<Long> responseTimeArray = new ArrayList<Long>(); //To average out reponseTime
...
//							System.out.println(queue.poll());
						...
						System.out.println("Thread: " + this.getName() + "		Process output: " + output);
				...
				synchronized(lock)
				{
					while(globalBoolean && !RRqueues.isEmpty()) //Loop only runs IF RRqueues is NOT empty. If this isn't clarified, the program will crash.
					{
						...
						if(queue.equals(RRqueues.get(0))) //If this queue is equal to the queue in the RRqueues Array at index 0, then proceed.
						{
							...
							long timeSlice = 1000; //time slice time
...
//		Main testSJF = new Main(20, 50); 
//		testSJF.simulationSJF();

//		Main testRR = new Main(3, 10);
//		testRR.simulationRR();	
		
//		Main testSJF = new Main(10, 20); 
//		testSJF.simulationSJF();

//		Main testRR = new Main(10, 20);
//		testRR.simulationRR();	
